...
<body>
    ...
    <ul>
        ...
        <!--link for added movie -->
        <li><a href="addMovie.jsp" target="_blank">Add New Movie</a></li>
        
        <!--link for update movie -->
        <li><a href="selectMovieToUpdate.jsp" target="_blank">Update Existing Movie</a></li>
        
        <!--link for delete movie -->
        <li><a href="deleteMovies.jsp" target="_blank">Delete Movie Records</a></li>
